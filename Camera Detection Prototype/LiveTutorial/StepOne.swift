...
class StepOne: UIViewController, UINavigationControllerDelegate {
...
//                context?.setStrokeColor(UIColor.yellow.cgColor)
        ...
        if let landmark = face.landmarks?.leftEye {
            ...
            let theImageView = UIImageView(frame: CGRect(origin: convert(point: imagePoint, offset: (x: 20.0, y: 20.0)), size: CGSize(width: 50, height: 50)))
...
//                context?.setStrokeColor(UIColor.yellow.cgColor)
        ...
        if let landmark = face.landmarks?.rightEye {
            ...
            let theImageView = UIImageView(frame: CGRect(origin: convert(point: imagePoint, offset: (x: -15.0, y: 20.0)) , size: CGSize(width: 50, height: 50)))
            newOverlays.append(theImageView)
...
//                context?.setStrokeColor(UIColor.yellow.cgColor)
        ...
        if let landmark = face.landmarks?.noseCrest {
            ...
            let theImageView = UIImageView(frame: CGRect(origin: convert(point: imagePoint, offset: (x: 15.0, y: -100.0)), size: CGSize(width: 50, height: 50)))
            newOverlays.append(theImageView)
